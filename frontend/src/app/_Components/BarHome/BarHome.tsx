  ...
  return <>
     <div className="bar flex items-center mb-12 justify-center gap-2 ">
                <div className="student-bar">
                  <Button
                    className={`flex items-center justify-between text-sm font-medium  rounded-md gap-1.5 px-3 pr-4 has-[>svg]:px-2.5 py-0 cursor-pointer border transition-all duration-200 transform-none  pb-[3px] ${
                      activeBar === "student"
                ...
                <div className="">
                  ...
                  >
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-user-check h-4 w-4 mr-2"
                    >
            ...
            <div className="projects flex flex-col items-center">
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                {/* from api */}
                <ProjectCard activeBar={activeBar} />
                <ProjectCard activeBar={activeBar} />
                <ProjectCard activeBar={activeBar} />
                <ProjectCard activeBar={activeBar} />
              </div>
