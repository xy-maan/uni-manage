...
//       <p className="text-xs text-muted-foreground mt-0.5">3 of 11 tasks</p>
//     </CardContent>
//   </Card>
...
//       <p className="text-xs text-muted-foreground mt-0.5">max 5</p>
//     </CardContent>
//   </Card>
...
//       </div>
//       <p className="text-2xl font-semibold">2/6</p>
...
//         <span className="font-medium">Graduation Project</span>
//       </div>

//       <div className="flex gap-3">
//         <span className="text-muted-foreground shrink-0 w-24">Methodology</span>
//         <span className="font-medium">Sprint (Agile)</span>
//       </div>
...
//       <div className="flex gap-3">
//         <span className="text-muted-foreground shrink-0 w-24">University</span>
//         <span className="font-medium">Fayoum University</span>
//       </div>

//       <div className="flex gap-3">
//         <span className="text-muted-foreground shrink-0 w-24">Semester</span>
//         <span className="font-medium">Second Semester 2025/2026</span>
//       </div>
...
//       <div className="flex gap-3">
//         <span className="text-muted-foreground shrink-0 w-24">Start Date</span>
//         <span className="font-medium">February 1, 2026</span>
//       </div>

//       <div className="flex gap-3">
//         <span className="text-muted-foreground shrink-0 w-24">Expected End</span>
...
//       >
//         github.com/fayoum-ai/academic-management
//       </Link>
//     </div>
//     </CardContent>
// </Card>
...
//   </CardHeader>
//     <CardContent className="px-6 pb-6">
//    <p className="text-sm text-muted-foreground leading-relaxed">We propose an AI-driven platform to modernize academic project management at Egyptian universities, reducing administrative overhead and improving student outcomes through intelligent automation.</p>
//    <p className="text-sm text-muted-foreground leading-relaxed mt-2">UniManage integrates ML-powered recommendations, real-time collaboration, and automated workflow management to transform how students and supervisors interact during academic projects.</p>
//     </CardContent>
// </Card>
//                 </div>
...
//         <div>
//           <p className="text-sm font-medium">Dr. Abdullah Mahmoud</p>
//           <p className="text-xs text-muted-foreground">
//             Primary Supervisor · Doctor
//           </p>
//           <p className="text-xs text-muted-foreground">
//             Fayoum University
//           </p>
...
//       <div className="flex items-start gap-3">
//         <div className="size-9 relative flex size-7 overflow-hidden rounded-full  shrink-0 ">
//           <div className="flex size-full items-center justify-center rounded-full text-xs bg-primary/10 text-primary">
//             MS
//           </div>
//         </div>
...
//         <div>
//           <p className="text-sm font-medium">Dr. Mariam Saleh</p>
//           <p className="text-xs text-muted-foreground">
//             Secondary Supervisor · TA
//           </p>
//           <p className="text-xs text-muted-foreground">
//             Cairo University
//           </p>
...
//         <div className="relative flex size-7 overflow-hidden rounded-fullshrink-0">
//           <div className="text-xs bg-muted flex size-full items-center justify-center rounded-full text-xs">AK</div>
//         </div>
...
//           <div>
//             <span className="font-medium">Youssef</span>
//             <span className="text-muted-foreground">
//               {" "}moved 'JWT auth' to Review
//             </span>
...
//             <span className="text-muted-foreground">
//               {" "}updated ML model training
//             </span>
//             <p className="text-muted-foreground">5h ago</p>
//           </div>
//         </div>
...
//           <div className="size-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
//           <div>
//             <span className="font-medium">Mariam</span>
//             <span className="text-muted-foreground">
//               {" "}completed dashboard wireframes
//             </span>
//             <p className="text-muted-foreground">1d ago</p>
//           </div>
//         </div>
...
//           <div className="size-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
//           <div>
//             <span className="font-medium">Dr. Abdullah</span>
//             <span className="text-muted-foreground">
//               {" "}posted new feedback
//             </span>
//             <p className="text-muted-foreground">5d ago</p>
//           </div>
//         </div>
//       </div>
//     </CardContent>
